...
public final class ModCommon {
	...
	// モッド名
	public static final String MOD_NAME = "ElonaMobs";
	public static final String MOD_PACKAGE = "mod.elm";
	public static final String MOD_CLIENT_SIDE = ".client.ClientProxy";
	public static final String MOD_SERVER_SIDE = ".core.CommonProxy";
	public static final String MOD_FACTRY = ".client.config.ElonaMobsFactory";
	...
	public static final String MOD_CHANEL ="Mod_Channel_ElonaMobs";
