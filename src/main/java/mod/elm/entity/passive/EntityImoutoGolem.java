...
public class EntityImoutoGolem extends EntityIronGolem{
	...
	public EntityImoutoGolem(World worldIn) {
		this(worldIn,EnumImoutoHead.NORMAL);
	}

	public EntityImoutoGolem(World worldIn,EnumImoutoHead rotten) {
		super(worldIn);
	}
